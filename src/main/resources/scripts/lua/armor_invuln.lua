...
local god_armor_tags = {
    ["transfinityimproved:praetor_helmet"]     = true,
    ["transfinityimproved:praetor_chestplate"] = true,
    ["transfinityimproved:praetor_leggings"]   = true,
    ["transfinityimproved:praetor_boots"]      = true,
    ["transfinityimproved:god_armor"]          = true,
