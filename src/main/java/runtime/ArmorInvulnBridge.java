...
public class ArmorInvulnBridge {
    ...
    static {
        GOD_ARMOR_TAGS.add("transfinity_improved:praetor_helmet");
        GOD_ARMOR_TAGS.add("transfinity_improved:praetor_chestplate");
        GOD_ARMOR_TAGS.add("transfinity_improved:praetor_leggings");
        GOD_ARMOR_TAGS.add("transfinity_improved:praetor_boots");
        GOD_ARMOR_TAGS.add("transfinity_improved:god_armor");
    }
